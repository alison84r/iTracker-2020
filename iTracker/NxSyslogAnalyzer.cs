                ...
                for (int i = 0; i < _fullBlockStrings.Count; i++)
                {
                    ...
                    if (blockString.Contains(Constant.DIALOG_BEGIN) && blockString.Contains("DA2"))
                    {
                        ...
                        else
                        {
                            ...
                            i0FeatureCommand.TimeStamp = String.Empty; //DateTime.Now.ToString("MM/dd/yyyy HH:mm:ss");
                        }
                        ...
                        i0FeatureCommand.Department = Nx.NxSession.GetStringAttributeValue("Department"); //Department
                                ...
                                i0FeatureCommand.CaptureSetting =
                                    new BsonArray
                                    {
                                        new BsonDocument
                                        {
                                            ...
                                            {"Final Setting", FormattedFinalSettings(i0FeatureCommand.FinalSettings)}
                                        }
                                    };
                                if (alertStrings.Any())
                                {
